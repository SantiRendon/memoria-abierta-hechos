...
DIRECTORIOS = [
    ...
    Path("hechos/reclutamiento_niños/data/processed/json"),
    Path("hechos/reclutamiento_niños/data/processed/csv"),
    ...
    Path("hechos/violencia_sexual/data/processed/json"),
    Path("hechos/violencia_sexual/data/processed/csv"),
...
ARCHIVOS_BASE = [
    ...
    Path("scripts/03_consolidar_datos.py"),
